...
const handleinsert = () => {
    ...
    handleseatData(rno, cinemaName, MovieName, time, seat);

    event.preventDefault();
}


const handleseatData = (rno, cinemaoption, movieoption, time, seat) => {
...
const handleupdate = (rno) => {
    ...
    document.getElementById("seat").value = Fdata[0].seat;
